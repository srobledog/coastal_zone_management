...
```{r}
wos_scopus_tos <- 
  tosr::tosr_load("data/coastal_management.bib",
                  "data/coastal_management_1_500.txt",
                  "data/coastal_management_501_1000.txt",
                  "data/coastal_management_1001_1500.txt",
                  "data/coastal_management_1501_2000.txt",
                  "data/coastal_management_2001_2240.txt")

tree_of_science <- 
  tosr::tosR("data/coastal_management.bib",
             "data/coastal_management_1_500.txt",
             "data/coastal_management_501_1000.txt",
             "data/coastal_management_1001_1500.txt",
             "data/coastal_management_1501_2000.txt",
...
wos <- 
  bibliometrix::convert2df(c("data/coastal_management_1_500.txt",
                             "data/coastal_management_501_1000.txt",
                             "data/coastal_management_1001_1500.txt",
                             "data/coastal_management_1501_2000.txt",
                             "data/coastal_management_2001_2240.txt"))  # create dataframe from wos file

scopus <- 
  bibliometrix::convert2df("data/coastal_management.bib", # Create dataframe from scopus file
                           dbsource = "scopus", 
                           format = "bibtex")
```
...
write.graph(wos_scopus_citation_network, "output/citation_network_full.graphml", "graphml") # Exporting graph
